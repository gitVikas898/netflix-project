    ...
    <div className="absolute w-screen aspect-video top-0 grid place-items-center justify-items-start bg-gradient-to-r from-black">
      <div className="w-1/2 grid gap-4 p-8">
        ...
        <div className="flex  gap-2">
          ...
          <button className="bg-white font-bold  text-slate-950 px-2 rounded-sm flex gap-2 items-center hover:opacity-75"> <img src={play} alt="" className="w-8" /> Play</button>
        </div>
      </div>
    </div>
  );
